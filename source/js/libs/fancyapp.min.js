...
Fancybox.bind('[data-fancybox="layout1"]', {
  //
});
Fancybox.bind('[data-fancybox="layout2"]', {
  //
});
Fancybox.bind('[data-fancybox="layout3"]', {
  //
});
Fancybox.bind('[data-fancybox="layout4"]', {
  //
});
Fancybox.bind('[data-fancybox="diploms"]', {
  //
});
Fancybox.bind('[data-fancybox="images_masterdom_zero"]', {
  //
});
Fancybox.bind('[data-fancybox="image_soyuzceramica"]', {
  //
});
Fancybox.bind('[data-fancybox="image_finefloor"]', {
  //
});
Fancybox.bind('[data-fancybox="image_parkett-shop"]', {
  //
});
Fancybox.bind('[data-fancybox="image_belwooddoors"]', {
  //
});
Fancybox.bind('[data-fancybox="image_dveri-city"]', {
  //
});
Fancybox.bind('[data-fancybox="image_elevel"]', {
  //
});
Fancybox.bind('[data-fancybox="image_stark-electro"]', {
  //
});
Fancybox.bind('[data-fancybox="individual"]', {
  //
});
